...
pub fn view(
  ...
  case typo {
    H1 -> lustre.to_lustre(theme, attributes, elements, h.h1)
    H2 -> lustre.to_lustre(theme, attributes, elements, h.h2)
    H3 -> lustre.to_lustre(theme, attributes, elements, h.h3)
    H4 -> lustre.to_lustre(theme, attributes, elements, h.h4)
    H5 -> lustre.to_lustre(theme, attributes, elements, h.h5)
    H6 -> lustre.to_lustre(theme, attributes, elements, h.h6)
    Pre(_) -> lustre.to_lustre(theme, attributes, elements, h.pre)
    Span(_) -> lustre.to_lustre(theme, attributes, elements, h.span)
    Label(_) -> lustre.to_lustre(theme, attributes, elements, h.label)
    Paragraph(_) -> lustre.to_lustre(theme, attributes, elements, h.p)
  }
}
...
pub fn text(
  ...
  view(typo, theme, attributes, [h.text(text), ..elements])
}
