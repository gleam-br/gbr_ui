...
pub fn edit(id: String, onclick_: a) {
  let inner = [
    svg.new(21, 21)
    |> svg_icons.pen()
    |> svg.view(),
  ...
  new(id)
  |> class(
    "text-gray-500 hover:text-yellow-700 dark:text-gray-400 dark:hover:text-yellow-500",
  )
...
const secondary_class = "justify-center inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]"

const const_tertiary_class = "justify-center text-theme-sm shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 sm:px-3.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
