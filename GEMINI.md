...
- **Interoperabilidade:** Utilize funções FFI para integrações com APIs de Browser (ex: Intersection Observer) que o Lustre ainda não abstrai.
...
2. **Web Components:** Foque na criação de componentes isolados que possam ser orquestrados por ferramentas externas.
...
4. **Modularidade:** Prepare os componentes para serem "cascas" que ferramentas externas poderão preencher dinamicamente.
